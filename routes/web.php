...
Route::get('/media-and-testimonials','HomeController@mediaAndTestimonials')->name('media_and_testimonials');
Route::get('/media-and-testimonials/{media_and_testimonials}','HomeController@shownewsdetail')->name('news_detail');
Route::get('/product-detail','HomeController@productDetail')->name('product_detail');
Route::get('/who-we-support','HomeController@whoWeSupport')->name('who_we_support');
Route::get('/volunteer-with-us','HomeController@volunteerWithUs')->name('volunteer_with_us');
Route::get('/size-guide','HomeController@sizeGuide')->name('size_guide');
Route::get('/faq','HomeController@faq')->name('faq_page');
...
Route::resource('admin/volunteer-zipper', 'Admin\\Volunteer_ZipperController');